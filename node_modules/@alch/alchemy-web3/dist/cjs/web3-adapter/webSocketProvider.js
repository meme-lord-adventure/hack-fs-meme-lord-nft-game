...
var AlchemyWebSocketProvider = /** @class */ (function (_super) {
    ...
    function AlchemyWebSocketProvider(ws, sendPayload, senders) {
            ...
            _this.heartbeatIntervalId = setInterval(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, promises_1.withTimeout(this.senders.send("net_version"), HEARTBEAT_WAIT_TIME)];
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 3];
                        case 2:
        ...
        _this.backfiller = subscriptionBackfill_1.makeBackfiller(senders);
    ...
    AlchemyWebSocketProvider.prototype.send = function (request, callback) {
        ...
        promises_1.callWhenDone(this.sendPayload(request), callback);
    };
